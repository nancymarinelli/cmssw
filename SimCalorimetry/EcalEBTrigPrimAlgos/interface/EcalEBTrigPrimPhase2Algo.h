...
{  
 public:
  ...
  void setPointers(
		   ...
		   //const EcalPhase2TPGLinearizationConst *ecaltpLin,
       const EcalTPGLinearizationConst *ecaltpLin,
		   const EcalPhase2TPGWeightIdMap *ecaltpgWeightMap,
		   const EcalPhase2TPGTimeWeightIdMap *ecaltpgTimeWeightMap,
 ...
 private:
  ...
  EcalPhase2TPGParamBuilder *param_builder_; 
  std::vector <EcalPhase2Linearizer *> linearizer_;
  EcalPhase2AmplitudeReconstructor *amplitude_reconstructor_; 
  EcalPhase2TimeReconstructor *time_reconstructor_;
  //EcalPhase2SpikeFinder *spike_finder_;
  EcalPhase2TPFormat *tpFormatter_;  

  //

  const EcalLiteDTUPedestalsMap * ecaltpPed_;  
  const EcalTPGCrystalStatus *ecaltpgBadX_;
  const EcalPhase2TPGWeightIdMap *ecaltpgWeightMap_;
  const EcalPhase2TPGTimeWeightIdMap *ecaltpgTimeWeightMap_;
  const EcalTPGWeightGroup *ecaltpgWeightGroup_;

  const EcalTPGLinearizationConst *ecaltpLin_;
  //const EcalPhase2TPGLinearizationConst *ecaltpLin_;
  /*
  ...
  */
  EcalPhase2TPGParamBuilder *getParamBuilder () const { return param_builder_;}
  //std::vector<std::vector<int>> paramb_out_;
  std::map<uint32_t,std::vector<uint>> paramb_out_;
  EcalPhase2Linearizer *getLinearizer (int i) const { return linearizer_[i];}
  std::vector<std::vector<int> > lin_out_;
  //
  EcalPhase2AmplitudeReconstructor *getAmplitudeFinder() const { return amplitude_reconstructor_;}
  ...
  EcalPhase2TimeReconstructor *getTimeFinder() const {return time_reconstructor_;}
  //EcalPhase2SpikeFinder *getSpikeFinder() const {return spike_finder};
  EcalPhase2TPFormat *getTPFormatter() const {return tpFormatter_;}  
