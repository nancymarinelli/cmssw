...
EcalEBPhase2Linearizer::EcalEBPhase2Linearizer(bool famos)
...

{
  ...
  // std::cout << " EcalEBPhase2Linearizer::setInput gainID  " << gainID_ << " base " << base_ <<  std::endl; 
  ...
  //  std::cout << " EcalEBPhase2Linearizer::setInput linConsts_  " <<  mult_  << " " << shift_ << std::endl; 
