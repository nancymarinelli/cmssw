...
//----------------------------------------------------------------------
//old void EcalEBPhase2TrigPrimAlgo::init(const edm::EventSetup & setup) {
...
void EcalEBPhase2TrigPrimAlgo::init() {
  ...
  linearizer_ = new  EcalEBPhase2Linearizer(famos_);
  ...
  tpFormatter_ = new EcalEBPhase2TPFormatter();
...
// old void EcalEBPhase2TrigPrimAlgo::run(const edm::EventSetup & setup, 
