#ifndef SimCalorimetry_EcalEBTrigPrimProducers_EcalPhase2TrigPrimESProducer_H
#define SimCalorimetry_EcalEBTrigPrimProducers_EcalPhase2TrigPrimESProducer_H
...
class EcalPhase2TrigPrimESProducer : public edm::ESProducer {
public:
  EcalPhase2TrigPrimESProducer(const edm::ParameterSet &);
  ~EcalPhase2TrigPrimESProducer() override;
  ...
  std::unique_ptr<EcalPhase2TPGWeightIdMap> produceAmpWeight(const EcalPhase2TPGWeightIdMapRcd &);
  std::unique_ptr<EcalPhase2TPGTimeWeightIdMap> produceTimeWeight(const EcalPhase2TPGTimeWeightIdMapRcd &);
