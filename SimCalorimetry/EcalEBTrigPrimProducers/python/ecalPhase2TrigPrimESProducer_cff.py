...
EcalPhase2TrigPrimESProducer = cms.ESProducer("EcalPhase2TrigPrimESProducer",
    DatabaseFile = cms.untracked.string('TPG_beamv5_MC_startup.txt.gz'),
#    WeightTextFile = cms.untracked.string('AmpTimeXtalWeights.txt.gz'),
    WeightTextFile = cms.untracked.string('AmpTimeOnPeakXtalWeights.txt.gz'),
...
#    recordName = cms.string('EcalTPGWeightIdMapRcd'),
    recordName = cms.string('EcalPhase2TPGWeightIdMapRcd'),
    iovIsRunNotTime = cms.bool(True),
    firstValid = cms.vuint32(1)
)

tpparams17 = cms.ESSource("EmptyESSource",
    recordName = cms.string('EcalPhase2TPGTimeWeightIdMapRcd'),
    iovIsRunNotTime = cms.bool(True),
    firstValid = cms.vuint32(1)
)
