...
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalEBPhase2TPGLinearizationConstant>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalTPGPedestal>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalEBPhase2TPGPedestal>);
